                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid"
                                           placeholder="{{ trans('cruds.user.fields.last_name') }}"
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                           ...
                                           name="fake_name" value="{{$user->fake_name ?? ''}}" id="fake_name"/>
                                    <span class="text-danger errors"
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="date" class="form-control form-control-solid"
                                           ...
                                           name="birth_date" value="{{$user->birth_date ?? ''}}" id="birth_date"/>
                                    <span class="text-danger errors"
                                    ...
                                    <select class="form-control form-control-solid" name="nationality" id="nationality" required>
                                        ...
                                        @isset($countries)
                                            @foreach($countries as $country)
                                                <option value="{{$country->title}}" @if($user->nationality == $country->title) selected @endif>{{$country->title}}</option>
                                    ...
                                    <select class="form-control form-control-solid" name="aria_id" id="aria_id" required>
                                        ...
                                        @isset($arias)
                                            @foreach($arias as $aria)
                                                <option value="{{$aria->id}}" @if($user->aria_id == $aria->id) selected @endif>{{$aria->title}}</option>
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="number" class="form-control form-control-solid"
                                           ...
                                           name="height" value="{{$user->height ?? ''}}" id="height"/>
                                    <span class="text-danger errors"
                            ...
                            <div class="col-md-6 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                           ...
                                           name="width" value="{{$user->width ?? ''}}" id="width"/>
                                    <span class="text-danger errors"
                                          id="width_error"> </span>
                                </div>
                            </div>
                            <div class="col-md-6 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select class="form-control form-control-solid" name="show_profile" id="show_profile" required>
                                        ...
                                        <option value="0" @if($user->show_profile == 0) selected @endif>إخفاء الملف الشخصي</option>
                                        <option value="1" @if($user->show_profile == 1) selected @endif>إظهار الملف الشخصي</option>
                                    </select>
                                    <span class="text-danger errors"
                        ...
                        <div class="row g-9 mb-8">
                            <div class="col-md-12 fv-row">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">{{ trans('cruds.user.fields.questions') }}</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                           title="Specify a target name for future usage and reference"></i>
                                    </label>
                                    <!--end::Label-->
                                            ...
                                            <div>
                                                <select class="form-control form-control-solid" name="answers[]" id="answers" required>
                                                    ...
                                                    @foreach($question->answers as $answer)
                                                        <option value="{{$answer->id}}" data-question_id="{{$question->id}}"
                                                                @if(getAnsweredQuestion($question->id,$user->id) ==$answer->id) selected
                                                            @endif>{{$answer->answer_title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).on('click', '#btn_update_user', function (e) {
            ...
            $.ajax({
                type: 'post',
                enctype: 'multipart/form-data',
                url: "{{ route("mediator.users.update", $user->id) }}",
