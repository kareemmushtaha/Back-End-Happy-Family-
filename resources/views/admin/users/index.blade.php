                    ...
                    @foreach ($users  as $key => $user)
                        <tr>
                            ...
                            <td>
                                ...
                                <button id="btn_un_active_{{$user->id}}" class="btn btn-success @if($user->check_active == 0) d-none @endif check_active btn-sm" data-check_active="{{$user->check_active}}" data-user_id="{{$user->id}}">
                                    غير مفعل
                                </button>
                                <button id="btn_active_{{$user->id}}" class="btn btn-danger @if($user->check_active == 1) d-none @endif check_active btn-sm" data-check_active="{{$user->check_active}}" data-user_id="{{$user->id}}">
                                    تفعيل
                                </button>
