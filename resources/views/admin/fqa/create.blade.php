...
@section('title',trans('global.add') .' '. trans('cruds.fqa.title_singular'))
@section('content')
        ...
        <div class="container">
            ...
            <div class="card card-custom example example-compact">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('global.add') }} {{ trans('cruds.fqa.title_singular') }}</h3>
                ...
                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="formFqa"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-10">
                            ...
                            <textarea name="answer" class="form-control" rows="6" id="answer">{{old('answer')}}</textarea>
                            <span class="text-danger errors"
