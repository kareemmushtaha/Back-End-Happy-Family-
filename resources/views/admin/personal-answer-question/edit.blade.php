                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control"
                                   ...
                                   name="answer_title_ar" id="answer_title_ar" value="{{ $answer->answer_title}}" required/>
                        ...
                        <div>
                            ...
                            <select class="form-control" name="status" id="status" multiple required>
                                ...
                                <option value="1"
                                        @if($answer->status ==1) selected @endif>{{trans('global.active')}}</option>
                                <option value="0"
                                        @if($answer->status ==0) selected @endif>{{trans('global.un_active')}}</option>
                            </select>
    ...
    <script>
        ...
        $(document).on('click', '#btn_update_answer_chat', function (e) {
            ...
            $.ajax({
                type: 'post',
                enctype: 'multipart/form-data',
                url: "{{ route("admin.personal-answer-questions.update", $answer->id) }}",
