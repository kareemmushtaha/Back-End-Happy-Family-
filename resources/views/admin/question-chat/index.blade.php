                ...
                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                    ...
                    @foreach ($questions  as $key => $question)
                        <tr>
                            ...
                            <td class="text-end">
                                @can('user_show')
                                    <a href="{{ route('admin.questions-chat.show', $question->id) }}"
                                ...
                                @can('user_edit')
                                    <a href="{{ route('admin.questions-chat.edit', $question->id) }}"
                                       class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                @can('user_delete')
                                    <button category_id_attr="{{$question->id}}"
                                            ...
                                            data-url="{{ route('admin.questions-chat.destroy', $question->id) }}">
    ...
    <script>
        ...
        $(document).on('click', '#btn_save_user', function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route("admin.questions-chat.store") }}",
