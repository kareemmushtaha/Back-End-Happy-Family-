    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container">
            <div class="card mb-5 mb-xl-8">
                ...
                <span
                    class="card-label fw-bold fs-3 mb-1">{{ trans('global.view') }} {{ trans('global.cities') }}</span>
                    </h3>
                    <div class="card-toolbar">
                        <a href=" " class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                           data-bs-target="#kt_modal_new_target">
                            <span class="svg-icon svg-icon-2 bi-bag-plus"></span>
                            {{ trans('global.add') }} {{ trans('global.city') }}</a>
    ...
    <script>
        ...
        $(document).on('click', '#btn_save_city', function (e) {
            ...
            $.ajax({
                ...
                url: "{{ route("admin.cities.store",$ariaId) }}",
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        setTimeout(function () {
                            var url = "{{ route('admin.cities.index',$ariaId) }}"; //the url I want to redirect to
