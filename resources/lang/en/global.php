...
return [
    ...
    'Files_to_download_and_reattach' => 'Files to download and re-attach',
    'file_name' => 'File Name',
    'Files_to_be_attached' => 'Files to be attached',
    'Files_uploaded_successfully' => 'Files uploaded successfully',
    'file_upload_required' => 'The required file must be attached',
    'file_upload_array' => 'The files should be in the form of an array',
    'file_upload_min' => 'There is a shortage of files, all files must be attached',
    'file_upload_max' => 'There is a shortage of files, all files must be attached',

    'Number_of_applications' => 'Number of applications',
    'The_number_of_users_whose_accounts_are_verified' => 'Number of verified users',
    'The_number_of_unverified_users' => 'Number of unverified users',
    'The_number_of_municipalities_that_have_completed_their_accounts' => 'Number of municipalities complete their accounts',
    'Number_of_municipalities_incomplete_their_accounts' => 'Number of municipalities incomplete their accounts',
    'Number_of_confirmed_stages' => 'Number of confirmed stages',
    'The_number_of_uncertain_stages' => 'Number of unconfirmed stages',

    'step_files_upload' => 'Step Files Upload',
    'Files_to_download_re_correct_and_reattach' => 'Files to be downloaded, corrected and re-attached',
    'reason_reject' => 'The reason of reject',
    'reject_user_in_project' => 'You were rejected by the administration. You cannot complete this application',
];
